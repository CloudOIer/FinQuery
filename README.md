...
财报智能问数系统:把 76 家医药上市公司的财报 PDF 与 164 篇研报,变成可以用自然语言提问的数据服务。
...
| 评测 | 结果 |
| --- | --- |
| 意图引擎:25 道变体题(口语化/换表述/错别字) | LLM 引擎 96% vs 规则引擎 44% | 
| 意图引擎:官方 49 题基本盘 | 槽位一致率 65.3%,差异人工判读多数为 LLM 更准 |
| RAG 检索:文档级消融 | hybrid+rerank hit_rate 91.3% / recall 59.1%,最优 |
| Agent vs 固定管道:30 道多意图/归因题盲评 | Agent 胜率 83%(25/30),0 降级 |
